...
private let unknownErrorMessage = NSLocalizedString("An unknown error has occurred",
                                                    comment: "A message showing that an error has occurred, but the specific error causing it is unknown.")
...
extension UIViewController {
    ...
    func showAlert(title: String? = nil,
        ...
        let alert = UIAlertController.createAlert(title: title,
                                                  message: message,
                                                  preferredStyle: preferredStyle,
                                                  actions: actions,
                                                  completion: completion)
...
extension UIAlertController {
    ...
    static func createAlert(title: String? = nil,
                            message: String? = nil,
                            preferredStyle: UIAlertController.Style = .alert,
                            actions: [UIAlertAction] = [.ok],
...
extension UIAlertAction {
    ...
    static func cancel(_ title: String = NSLocalizedString("Cancel", comment: ""),
